...
// Top-level response from TheCocktailDB for lookups/searches
data class CocktailResponse(
    val drinks: List<Drink>?
)

// Minimal fields we need for Recipe Details + offline save
data class Drink(
    val idDrink: String?,           // e.g. "17196"
    val strDrink: String?,          // e.g. "Cosmopolitan"
    val strInstructions: String?,   // steps
    val strDrinkThumb: String?,     // image url

    // Up to 15 ingredients & measures (API uses these exact names)
